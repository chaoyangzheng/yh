...
import com.yh.common.ExceptionJsonResult;
...
public class MyHandlerExceptionResolver {
    ...
    private static Logger log = LoggerFactory.getLogger(MyHandlerExceptionResolver.class);
    ...
    private <T extends Throwable> String resultFormat(Integer code, T ex) {
        ...
        return ExceptionJsonResult.failed(code, ex.getMessage());
    }
